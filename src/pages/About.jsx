          ...
          >
            ...
            >
              <p className="text-sm sm:text-base md:text-lg text-blue-100 leading-relaxed px-2 sm:px-4">
                KRFoods is your trusted partner in quick food delivery, grocery essentials, and unforgettable flavors — delivered with speed, safety, and simplicity.
              </p>
            </motion.div>
          </motion.div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="flex flex-col justify-center">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  KRFoods was built on the foundation of trust, quality, and a deep
                  respect for India’s rich culinary heritage. Our founder,
                  <span className="text-blue-700 font-semibold"> Shri Jagadeesh </span>,
          ...
          <div className="bg-gray-50 py-12 px-4 md:py-20 md:px-8 ">
            ...
            <div className="max-w-4xl mx-auto text-center mb-12 ">
              ...
              <p className="mt-3 text-gray-600 text-sm md:text-base">
                KRFoods brings together flavour, convenience, and smart savings so that
      ...
      <div className="bg-slate-50 py-12 px-4 md:py-20 md:px-8">
        ...
        <div className="max-w-4xl mx-auto text-center mb-10 md:mb-14">
          ...
          <p className="mt-3 text-sm md:text-base text-slate-600">
            Every decision at KRFoods is guided by a few core principles that keep
      ...
      <div className="bg-gray-50 py-12 px-4 md:py-15 md:px-8">
        ...
        <div className="max-w-4xl mx-auto text-center mb-10">
          ...
          <p className="text-sm md:text-base text-gray-600">
            ...
            <span className="font-semibold text-blue-600">KRFoods</span>.
          </p>
        </div>
            ...
            <div className="relative bg-white rounded-3xl border border-sky-100 shadow-md p-6 md:p-7 h-full flex flex-col justify-between transform group-hover:-translate-y-2 group-hover:shadow-2xl transition-all duration-500">
              <div>
                ...
                <p className="text-sm md:text-[15px] text-gray-700 leading-relaxed mb-3">
                  List your restaurant on KRFoods and reach thousands of nearby customers discovering new places to eat every day.
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white rounded-3xl border border-sky-100 shadow-md p-6 md:p-7 h-full flex flex-col justify-between transform group-hover:-translate-y-2 group-hover:shadow-2xl transition-all duration-500">
              <div>
                ...
                <p className="text-sm md:text-[15px] text-gray-700 leading-relaxed mb-3">
                  Share your signature recipes with your city. KRFoods helps passionate home chefs become loved local brands
        ...
        <div className="mt-10 text-center text-sm md:text-base text-gray-700">
          Ready to join the KRFoods ecosystem?{" "}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-4 mb-10 md:mb-12">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-gray-800 mb-6 text-center">
              Careers At <span className="text-blue-800">KRFoods</span>
            </h1>
              ...
              <div className="flex flex-col md:flex-row items-stretch">
                ...
                <div className="w-full md:w-1/2 p-6 md:p-10">
                  ...
                  <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-4">
                    ...
                    delighting customers — there’s a place for you at KRFoods.
                  </p>
                  ...
                  <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-6">
                    ...
                    openings and start your next chapter with KRFoods.
                  </p>
