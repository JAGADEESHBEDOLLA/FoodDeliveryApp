...
const SignIn = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Example: navigate to dashboard after sign-in:
    // navigate('/dashboard');
      ...
      <div className="max-w-md w-full">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="flex items-center gap-2 mb-2">
            <img src="/public/footer.png" alt="KRFoods Logo" className="w-10 h-10 object-contain" />
            <span className="text-2xl font-extrabold text-blue-800">KRFoods</span>
          </div>
        ...
        <div className="relative bg-white rounded-3xl shadow-lg border border-sky-100 px-6 py-7 md:px-8 md:py-8">
          <h2 className="text-lg md:text-xl font-semibold text-gray-900 mb-4">Sign in to your account</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-xs md:text-sm">
              <label className="flex items-center gap-2">
                <input type="checkbox" name="remember" checked={form.remember} onChange={handleChange} className="rounded border-gray-300 text-orange-500 focus:ring-orange-500" />
            ...
            {/* Submit */}
            <button type="submit" className="w-full mt-2 inline-flex items-center justify-center px-4 py-2.5 rounded-full bg-blue-500 text-white text-sm font-semibold shadow-md hover:bg-blue-600 hover:shadow-lg transition-all">
              Sign In
            </button>
          </form>
