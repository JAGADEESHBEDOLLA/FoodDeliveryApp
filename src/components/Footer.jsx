            ...
            <div className="max-w-7xl mx-auto">
             ...
             hover:bg-gray-200 transition">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-blue-200 text-sm">
                            <li>KR Kitchens</li>
                            <li>KR Foods Delivery</li>
                            <li>KR Events Catering</li>
                        </ul>
                    </div>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between text-blue-300 text-xs mt-4">
                    ...
                    <div className="order-1 md:order-1">
                        <p>© {new Date().getFullYear()} KRFoods. All rights reserved.</p>
                    </div>

                    {/* center: designed by */}
                    <div className="order-3 md:order-2 mt-3 md:mt-0 text-center w-full md:w-auto">
                        <p>© Designed by <span className="font-medium text-white">KRwebdevolopers</span></p>
                    </div>
