  ...
  const slides = [
    {
      ...
      text: "Our smart delivery network, intelligent routing, and real-time batching help your order reach quickly, even during rush hours. Customers love that KRFoods respects their time as much as their appetite.",
